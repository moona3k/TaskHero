        ...
        return (
            <div className="task-description-container">
                <div className="task-description-header">
                    <h1 className="task-description-header-title">Describe Your Task: ________</h1>
                    <h3 className="task-description-header-sub">Is _______ not the right task? (Pick another task)</h3>
                </div>
                <div>
